...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(u => u.KeycloakId).IsRequired().HasMaxLength(200);
            entity.HasIndex(u => u.KeycloakId).IsUnique().HasDatabaseName("UX_User_KeycloakId");
            ...
            // Removido HasDefaultValueSql para deixar o C# controlar a data
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            // Removidos HasDefaultValueSql de CreatedAt e UpdatedAt
        ...
        modelBuilder.Entity<CartItem>(entity =>
        {
            ...
            // Removido HasDefaultValueSql de AddedAt
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            // Removido HasDefaultValueSql de CreatedAt
        });
        ...
        modelBuilder.Entity<OrderItem>(entity =>
        {
            ...
            // Removido HasDefaultValueSql de CreatedAt — Agora o OrderItem.cs controla
